...
const FAMILIES = [
  ...
  },
  {
    ...
    layouts: [
      ...
      { name: 'card-deck', source: `type: card-deck\n- Design\n  - UI/UX\n  - Figma\n- Engineering\n  - Frontend\n  - Backend\n- Growth\n  - Marketing\n  - Sales` },
  ...
  },
  {
    ...
    layouts: [
      ...
      { name: 'history', source: `type: history\n- 2022: Founded\n- 2023: Seed round\n- 2024: Product launch\n- 2025: Series A\n- 2026: Expansion` },
      { name: 'history (alternating)', source: `type: history\nshape: alternating\n- Research\n- Prototype\n- Test\n- Launch` },
    ],
  },
  {
    name: 'Technical',

...
_X-Y plots: series of values across an axis with optional shaded zones and reference lines._
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./examples/gallery/line-chart.svg">
  <img alt="line-chart" src="./examples/gallery/line-chart-light.svg">
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./examples/gallery/scatter.svg">
  <img alt="scatter" src="./examples/gallery/scatter-light.svg">
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./examples/gallery/area-chart.svg">
  <img alt="area-chart" src="./examples/gallery/area-chart-light.svg">
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./examples/gallery/bar-chart.svg">
  <img alt="bar-chart" src="./examples/gallery/bar-chart-light.svg">
</picture>
